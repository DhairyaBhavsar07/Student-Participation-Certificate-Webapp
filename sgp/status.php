...
<html>
    ...
    <body>
        ...
        <div class="backdrop">
        <h1 style="color: black;">Check your certificate Status here!</h1>
    <?php
        $user = $_SESSION['user'];
        $q = "SELECT * FROM `data` WHERE `user`='$user'";
                        ...
                        <article class="card shadow curve">
                            ...
                            <div>
                              ...
                              <!-- <form id="tbtn" action="upload.php" method="POST"> -->
                                <?php
                                    if($obj['status_1']=="approved")
                                    {
                                        ?>
                        <button  class="yes">Approved</button>
                                    <?php
                                    }
                                    else if($obj['status_1']=="denied")
                                    {
                                        ?>
                        <button style="background-color: red; " class="yes">Denied</button>
                        <a href="#" style="margin: 5%;" name="tbtn" onclick="openForm1()">Upload Again</a>

                                    <?php
                                    }
                                    else if($obj['status_1']=="--")
                                    {
                                        ?>
                                        <h4>Waiting for admin to verify...</h4>
                                        <?php
                                    }
                                    else if($obj['status_1']=="no")
                                    {
                                        ?>
                                        <h4>Upload pending. Click Here to Upload.</h4>
                        <a href="#" style="margin: 70%;" name="tbtn" onclick="openForm1()">Upload</a>
                                        <?php
                                    }
                                ?>
                            </div>
                          ...
                          <article class="card shadow curve">
                            ...
                            <div>
                              <p>Non-Technical Certificate</p>
                                <!-- <a href="#" name="nbtn" onclick="openForm2()">Upload</a> -->
                                <?php
                                    if($obj['status_2']=="approved")
                                    {
                                        ?>
                        <button  class="yes">Approved</button>
                                    <?php
                                    }
                                    else if($obj['status_2']=="denied")
                                    {
                                        ?>
                        <button style="background-color: red;" class="yes">Denied</button>
                        <a href="#" style="margin: 5%;" name="tbtn" onclick="openForm2()">Upload Again</a>

                                    <?php
                                    }
                                    else if($obj['status_2']=="--")
                                    {
                                        ?>
                                        <h4>Waiting for admin to verify...</h4>
                                        <?php
                                    }
                                    else if($obj['status_2']=="no")
                                    {
                                        ?>
                                        <h4>Upload pending. Click Here to Upload.</h4>
                        <a href="#" style="margin: 70%;" name="tbtn" onclick="openForm2()">Upload</a>
                                        <?php
                                    }
                                ?>
                            </div>
                          ...
                          <article class="card shadow curve">
                            ...
                            <div>
                              <p>Online Course Certificate</p>
                                ...
                                <?php
                                    if($obj['status_3']=="approved")
                                    {
                                        ?>
                        <button  class="yes">Approved</button>
                                    <?php
                                    }
                                    else if($obj['status_3']=="denied")
                                    {
                                        ?>
                        <button style="background-color: red;" class="yes">Denied</button>
                        <a href="#" style="margin: 5%;" name="tbtn" onclick="openForm3()">Upload Again</a>

                                    <?php
                                    }
                                    else if($obj['status_3']=="--")
                                    {
                                        ?>
                                        <h4>Waiting for admin to verify...</h4>
                                        <?php
                                    }
                                    else if($obj['status_3']=="no")
                                    {
                                        ?>
                                        <h4>Upload pending. Click Here to Upload.</h4>
                        <a href="#" style="margin: 70%;" name="tbtn" onclick="openForm3()">Upload</a>
                                        <?php
                                    }
                                ?>
                            </div>
