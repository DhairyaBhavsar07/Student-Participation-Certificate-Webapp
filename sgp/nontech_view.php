...
<?php
    ...
    <nav class="navbar" style="position: fixed;">
        <div class="navbar-container">
            ...
            <ul class="menu-items">
                ...
                <!-- <li><a href="nontech_view.html">Non-Technical</a></li> -->
    ...
    <div class="backdrop">
        ...
        <form action="nontech_view.php" method="post">
        <div class="display-certi">
        <?php
            $q = "SELECT * FROM `data` WHERE `status_2` != 'no'";
            ...
            ?> 
                <div class="container">
                    ...
                    <a href="<?php echo "final/".$obj['image_2'] ?>" target="_blank"><img src="<?php echo "final/".$obj['image_2'] ?>" alt='certi image' class="profile-img"></a>
                    ...
                    <div class="description">  
                        <ul>
                            ...
                            <li>Status: <?php echo $obj['status_2'] ?></li>
                        </ul>
                    </div>
                    <div class="status">
...
// unset($_POST['abtn'.$count]);
                ...
                if(isset($_POST['abtn'.$count]))
                {
                    ...
                    ?>
                    <script>window.location.href = "nontech_view.php"</script>
<?php
                    // if($res)
                    // {
                        //     echo "Approved..!!";
